...
const Hero = () => {
  return (
    <section className="h-screen bg-var-black text-white">
      <div className="w-3/4 max-w-[700px] mx-auto mt-52 flex flex-col gap-y-12 text-center">
        {/* Content */}
        <header>
      ...
      {/* Dashboard Image  */}
      <div className="relative bottom-0 left-0 text-blue-400 w-full flex justify-center ">
