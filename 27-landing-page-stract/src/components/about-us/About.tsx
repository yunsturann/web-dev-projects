  ...
  return (
    <section className="py-20 md:py-32 bg-var-black text-white relative">
      <Container className="flex flex-col lg:flex-row justify-between gap-20">
        {/* Left Img */}
        <div className="flex-1 relative min-h-[320px] lg:h-[460px] w-2/3 lg:w-full mx-auto">
          <Image
        ...
        <div className="flex-1 max-lg:text-center">
          <h2 className="text-4xl lg:text-5xl font-semibold leading-[1.2]">
            Know More About
            <br /> Stract
          </h2>
          <p className="mt-4 mb-8 text-var-gray">
          ...
          <div className="flex items-center max-lg:justify-center gap-x-6 lg:gap-x-16">
            <Rating number="4.5/5" title="Customer Rating" />
            <Rating number="425" title="Security Testing" />
          </div>
